...
<div class="form-container">
    <div class="col-md-12">
<form method="post" id="post_form" role="form" class="registration-form" action="{{ route('project.store') }}" enctype="multipart/form-data">
        @csrf

        <h3><i class="fa fa-calendar-check-o"></i>PROJECT REGISTRATION FORM</h3>
...
<option value="Inactive">Inactive</option>
 ...
 <hr>
          <div class="d-flex justify-content-between mt-3">
             <a href="/project" role="button" class="btn-previous">Cancel</a>

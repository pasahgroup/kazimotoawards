  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2 align-items-center">
        <div class="col-sm-10">
          <h4 class="asset">Project List</h4>
        </div>

        <div class="col-sm-2 d-flex justify-content-end gap-3">     
       
          <a href="{{ route('project.create') }}" class="btn btn-gradient">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <form method="GET" action="{{ route('project.edit',$data->id) }}" class="d-inline">
                    @csrf
                  ...
                  <a href="#" class="deletebtn btn-sm btn-danger btn-delete text-white" data-url="/project-destroy/{{$data->id}}" data-message="Are you sure you want to delete this asset?">

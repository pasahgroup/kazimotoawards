  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2 align-items-center">
        <div class="col-sm-10">
          <h4 class="asset">Bank list</h4>
        </div>

        <div class="col-sm-2 d-flex justify-content-end gap-3">     
       
          <a href="{{ route('bank.create') }}" class="btn btn-gradient">
            <i class="fas fa-plus"></i>Bank
          </a> 
              ...
              <tr>
                ...
                <td>{{ $data->bank_name }}</td>
                 ...
                 <td>{{ $data->bank_account_no }}</td> 
                  <td>{{ $data->bank_holder_name }}</td> 
                   <td>{{ $data->currency }}</td> 
                    <td>{{ $data->country }}</td> 

                 <td>{{ $data->status }}</td>
                <td>                
                  <form method="GET" action="{{ route('bank.edit',$data->id) }}" class="d-inline">
                    @csrf

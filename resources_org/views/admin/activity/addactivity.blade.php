...
<div class="form-container">
    <div class="col-md-12">
<form method="post" id="post_form" role="form" class="registration-form" action="{{ route('activity.store') }}" enctype="multipart/form-data">
        @csrf

        <h3><i class="fa fa-calendar-check-o"></i>ACTIVITIES REGISTRATION FORM</h3>
        <fieldset class="active">
            <div class="form-group row">        
           <div class="col-md-6 col-sm-12">
        <label>Activity Name</label>

        <input type="text" name="activity_name" placeholder="enter your activity name" id="activity_name" class="form-control" maxlength="64" required>

  </div>
   
      <div class="col-md-6 col-sm-12">
         <label>Activity level</label>
         <input type="text" name="activity_level" placeholder="enter your activity level" id="activity_level" class="form-control" maxlength="64" required>   
  </div>
  </div>
...
<option value="Inactive">Inactive</option>
 ...
 <hr>
          <div class="d-flex justify-content-between mt-3">
             <a href="/activity" role="button" class="btn-previous">Cancel</a>

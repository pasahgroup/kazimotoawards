  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2 align-items-center">
        <div class="col-sm-10">
          <h4 class="asset">Activities list</h4>
        </div>

        <div class="col-sm-2 d-flex justify-content-end gap-3">     
       
          <a href="{{ route('activity.create') }}" class="btn btn-gradient">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{ $data->activity_name }}</td>
                 ...
                 <td>{{ $data->activity_percent }}</td> 
                 <td>{{ $data->status }}</td>
                <td>
                
                  <form method="GET" action="{{ route('activity.edit',$data->id) }}" class="d-inline">
                    @csrf
                  ...
                  <a href="#" class="deletebtn btn-sm btn-danger btn-delete text-white" data-url="/activity-destroy/{{$data->id}}" data-message="Are you sure you want to delete this activity?">

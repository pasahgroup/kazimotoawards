...
<div class="form-container">
    <div class="col-md-12">
    <form method="POST" id="post_form" role="form" class="registration-form" action="{{ route('aboutus.update',$aboutus->id) }}" enctype="multipart/form-data">
        @csrf
     ...
     <div class="form-group row">        
      ...
      <div class="form-group row">
            <div class="col-md-12 col-sm-12">
              <label>Mission Photo</label>
                 ...
                 <div class="col-lg-4 col-md-12 col-sm-12">
                                    ...
                                    <input type="file" name="mission_photo[]" onChange="displayImage(this)" id="mission_photo" accept="image/*" class="" style="display:block;">
            ...
            <span class="img-div">
              ...
              <img src="{{ URL::asset('/storage/aboutus/'.$aboutus->mission_photo) }}" onClick="triggerClick()" id="profileDisplay">
            </span>
            </div>
 ...
 <div class="form-group row">
            <div class="col-md-12 col-sm-12">
              <label>Vision Photo</label>
                 ...
                 <div class="col-lg-4 col-md-12 col-sm-12">
                                    <label for="password_confirmation" :value="('Image')" />
                                    <div class="form-group">
                                    <input type="file" name="vision_photo[]" onChange="displayImageVision(this)" id="vision_photo" accept="image/*" class="" style="display:block;">
            ...
            <span class="img-div">
              ...
              <img src="{{ URL::asset('/storage/aboutus/'.$aboutus->vision_photo) }}" onClick="triggerClick()" id="profileDisplayVision">
            </span>
            </div>
              ...
              <select class="form-control" name="status" id="status">
                 <option selected>{{$aboutus->status}}</option>
                <option></option>
...
<hr>
          <div class="d-flex justify-content-between mt-3">
             <a href="/aboutus" role="button" class="btn-previous">Back</a>

    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-11 form-box">
                <form method="post" id="post_form" role="form" class="registration-form" action="{{ route('supply.store') }}" enctype="multipart/form-data">

                    <fieldset>
                           @csrf                     
                        <div class="form-top">
                            <div class="form-top-left">
                                <h3><span><i class="fa fa-calendar-check-o" aria-hidden="true"></i></span>Supply registration form</h3>
                        ...
                        <div class="form-bottom">
                            <div class="row">
                                ...
                                <div class="form-group col-md-8 col-sm-8">
                                    ...
                                    <input type="text" class="form-control" name="supply_name">
                                </div>

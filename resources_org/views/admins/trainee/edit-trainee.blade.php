                          ...
                          <!--   </div>
                              ...
                              <div class="row"> -->
                                <div class="form-group col-md-2 col-sm-6">
                                    ...
                                    <input type="number" class="form-control" name="no_of_topic" min="0" max="20" maxlength="2" value="{{$datas->no_topic}}">
                                </div>
                                <div class="form-group col-md-2 col-sm-6">
                                    <label>Trained Topics</label>
                                    <input type="number" class="form-control" name="trained_topic" min="0" max="20" maxlength="2" value="{{$datas->trained_topic}}">
                                </div>
                            </div>
                            ...
                            <option>{{$datas->gender}}</option>
                                      ...
                                      <div class="form-group col-md-4 col-sm-4">
                                        ...
                                        <input type="text" class="form-control" name="mobile_no" value="{{$datas->mobile_no}}" required>
                                    </div>
                               ...
                               <div class="form-group col-md-4 col-sm-4">
                                      <div class="form-group"> 
                                       <label>Email</label>
                                <input type="email" name="email" placeholder="Email" class="form-email form-control" value="{{$datas->email}}">
                            </div>
                          </div>
...
<div class="row">
  <div class="col-lg-4 col-md-12 col-sm-12">
            ...
            <span class="img-div float-right">
              ...
              <img src="{{ URL::asset('/storage/trainee/'.$datas->photo) }}" onClick="triggerClick()" id="profileDisplay">
            </span>
            </div>

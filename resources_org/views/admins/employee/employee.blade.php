        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active"><a href="{{ route('employee.create') }}" class="btn btn-primary" >
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <!--    <td>{{ $data->main }}</td>
                     <td>{{ $data->tour_code }}</td> -->
                      <td><div class="logo mr-auto"><img src="{{ URL::asset('/storage/employees/'.$data->photo) }}"  style="width:100px; height:60px;"></div></td>
...
<button type="submit" role="button" class="btnn btn-primary"><i class="fa fa-bars"></i></button>
  ...
  @if(Auth::user()->role =='Admin')
                      <a role="button" href="{{ route('editemployee',$data->id) }}" class="btnn btn-secondary"><i class="fa fa-edit"></i></a> 
                      @endif
                     
                      <a role="button" class="btnn btn-success" href="/destroyEmployee/{{$data->id}} " onclick="return confirm('Are you sure? You want to delete {{ $data->tour_name}}','Inclusive')"><i class="fa fa-trash red"></i></i></a>

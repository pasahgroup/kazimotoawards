...
<div class="form__container">
 ...
 <div class="col-md-6 col-lg-6 col-sm-6">
              ...
              <div class="form-card">
                            <div class="">
                                 <div class="col-12" style="background-color:#e9ece9">
                                    <h4 class="fs-title">Experience Details:| Step 2 - 3</h4>
                                </div>                                
                            </div> 
...
@endforeach     
 ...
 <div class="row">
    ...
    <div class="row" style="padding-left:10px;padding-right:10px;">
                    ...
                    <fieldset class="active__form" id="form3">
                        <div class="">
                                 <div class="col-12" style="background-color:#e9ece9">
                                    <h4 class="fs-title">Evidence Photos:| Step 3 - 3</h4>
                                </div>                                
                            </div>
 ...
 <div class="input__container">
   <div class="col-md-12">
                            ...
                            <div class="buttons">
                                <a class="prev__btn" onclick="prevForm();" >Back</a>
                              <a class="nxt__btn" type="submit" id="submitBtn">Submit</a>    

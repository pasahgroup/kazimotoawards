...
<body>
  ...
  <div class="page-title">
    ...
    <div class="link">
      ...
      <span class="page">Blog List</span>
    </div>
  ...
  <section class="blog list">
    ...
    <div class="sidebar">
      ...
      <div class="search sidebar-item">
        ...
        <form class="blog-search-container box-container">
          <div class="input-box">
            <input type="search" id="blog-search" placeholder="search..." required> <!-- Search Input -->
            <button type="submit"><i class="fas fa-search"></i></button> <!-- Submit Button -->
          </div>
        </form>
      ...
      <div class="category sidebar-item">
        ...
        <div class="box-container">
          <a href="#" class="item"> <span><i class="fa-solid fa-hammer"></i>School projects</span> <p>(70)</p> </a>
          <a href="#" class="item"> <span><i class="fa-solid fa-hammer"></i>where to start </span> <p>(10)</p> </a>
          <a href="#" class="item"> <span><i class="fa-solid fa-hammer"></i>Class Trends</span> <p>(35)</p> </a>
          <a href="#" class="item"> <span><i class="fa-solid fa-hammer"></i>Way Forward</span> <p>(0)</p> </a>
          <a href="#" class="item"> <span><i class="fa-solid fa-hammer"></i>Inspiration Gallery</span> <p>(05)</p> </a>
        </div>
      ...
      <div class="recent-posts sidebar-item">
        ...
        <div class="box-container">
          ...
          <!-- Recent Post 1 -->
          <div class="post-item">
            <img src="../../assets/images/Blog/Blogs/Blog-1.jpg" alt="Recent-Post-Image"> <!-- Post image -->
            <a class="main-heading" href="../../pages/Blog/Blog-Single.html">Renovating Your Kitchen Cabinets: Before And After</a> <!-- Post title -->
          </div>
  
          <!-- Recent Post 2 -->
          <div class="post-item">
            <img src="../../assets/images/Blog/Blogs/Blog-2.jpg" alt="Recent-Post-Image"> <!-- Post image -->
            <a class="main-heading" href="../../pages/Blog/Blog-Single.html">Mastering Basic Woodworking Joints</a> <!-- Post title -->
          </div>
  
          <!-- Recent Post 3 -->
          <div class="post-item">
            <img src="../../assets/images/Blog/Blogs/Blog-3.jpg" alt="Recent-Post-Image"> <!-- Post image -->
            <a class="main-heading" href="../../pages/Blog/Blog-Single.html">The Rise Of Minimalist Wood Furniture</a> <!-- Post title -->
          </div>
      ...
      <div class="tags sidebar-item">
        ...
        <!-- Tags -->
        <div class="box-container">
          <a href="#" class="tag-item">Carpentry</a>
          <a href="#" class="tag-item">Design</a>
          <a href="#" class="tag-item">Tips</a>
          <a href="#" class="tag-item">Woodworking</a>
          <a href="#" class="tag-item">Techniques</a>
          <a href="#" class="tag-item">Home</a>
          <a href="#" class="tag-item">Projects</a>
          <a href="#" class="tag-item">Inspiration</a>
        </div>
    ...
    <div class="blog-container list">
      ...
      <!-- ===== Blogs (Start) ===== -->
        ...
        <div class="blog-item">
          <div class="image">
            <img src="../../assets/images/Blog/Blogs/Blog-4.jpg" alt="Blog-Image"> <!-- Blog Image -->
            <div class="date"><span>27</span> Jan</div> <!-- Blog Date -->
          </div>
          <div class="content">
  
            <a class="main-heading" href="../../pages/Blog/Blog-Single.html">Essential Tools Every Woodworker Should Own</a> <!-- Blog Title -->
            <div class="details">
              <h3><i class="fa-solid fa-circle-user"></i><span>By Admin</span></h3> <!-- Blog Author -->
              <h3><i class="fa-solid fa-tags"></i><span>Tips & Tricks</span></h3> <!-- Blog Category -->
            </div>
          </div>
        </div>
      ...
      <div class="pages-no">
        ...
        <div class="container">
          ...
          <!-- Page numbers -->
          <div class="numbers">
            <div class="item active">1</div> <!-- Active page number -->
            <div class="item">2</div> <!-- Page number 2 -->
            <div class="item">3</div> <!-- Page number 3 -->
          </div>

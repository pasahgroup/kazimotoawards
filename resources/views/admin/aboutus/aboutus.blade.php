  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2 align-items-center">
        <div class="col-sm-10">
          <h4 class="asset">About-us List</h4>
        </div>

        <div class="col-sm-2 d-flex justify-content-end gap-3">     
       
          <a href="{{ route('aboutus.create') }}" class="btn btn-gradient">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><img src="{{ URL::asset('/storage/aboutus/'.$data->mission_photo) }}" alt="Mission Photo"></td>
                 <td>{{ $data->vision }}</td>  
                 <td><img src="{{ URL::asset('/storage/aboutus/'.$data->vision_photo) }}" alt="Vision Photo"></td>           
                <td>{{ $data->status }}</td>
                <td>
                
                  <form method="GET" action="{{ route('aboutus.edit',$data->id) }}" class="d-inline">
                    @csrf
                    <input type="hidden" name="user_id" value="PUT">
                    <input type="hidden" name="asset_id" value="#">
                    <input type="hidden" name="sessionf" value="#">
                    <input type="hidden" name="searchf" value="#">
                    <button type="submit" class="editbtn">
                      <i class="fa fa-edit"></i> Edit
                    </button>
                  </form>

                  <a href="#" class="deletebtn btn-sm btn-danger btn-delete text-white" data-url="/aboutus-destroy/{{$data->id}}" data-message="Are you sure you want to delete this asset?">

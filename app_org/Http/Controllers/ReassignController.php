...
class ReassignController extends Controller
{
    ...
    {       
         ...
         $search="iflag";
         $assets = asset::join('reasigns','assets.category','reasigns.asset_id')
        ->select('reasigns.*','assets.asset_name')
...
//dd($assets);
  ...
  //$classes = classg::where('class',request('classg'))
         ...
         $sessions = sessiom::where('class_name',request('classg'))
               ->get();
          //dd($assets);
             return view('admins.reassign.assign',compact('assets','categories','sessions','search'));
 ...
 $employees = employee::where('full_name','<>',"")
 ->where('status',"Active")
 ->get(); 
...
$assets = asset::join('categories','assets.category','categories.id')
->select('assets.id','assets.asset_name','categories.category')
->get();
...
$categories = category::get();
  ...
  //$classes = classg::where('class',request('classg'))
         ...
         $sessions = sessiom::where('class_name',request('classg'))
               ->get();
        // dd($assets);
             return view('admins.reassign.add-reassign',compact('assets','employees','categories','assets','search','locations'));
    }
...
//dd($id);
         ...
         // $empData['data'] = asset::where('id',$id)->first();
      //  $assets = asset::join('categories','assets.category','categories.id')

          $empData['data'] = asset::join('categories','assets.category','categories.id')
          ->where('assets.id',$id)
              ->get();
